...
class DocumentResponse {
    ...
    factory DocumentResponse.fromJson(Map<String, dynamic> json) => DocumentResponse(
        documents: List<AppDocument>.from(json["documents"].map((x) => AppDocument.fromJson(x))),
    );
...
class AppDocument {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "approvalDate": approvalDate != null ? "${approvalDate!.year.toString().padLeft(4, '0')}-${approvalDate!.month.toString().padLeft(2, '0')}-${approvalDate!.day.toString().padLeft(2, '0')}" : null,
